                        ...
                        @else
                            @foreach($customers as $key=>$customer)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('admins.customer.edit', $customer->id) }}" class="btn btn-info"><i class="fa fa-pencil"></i> Editar</a>

                                        <a data-eliminar data-id="{{ $customer->id }}" data-name="{{ $customer->name }}" class="btn btn-danger"><i class="fa fa-trash"></i> Eliminar</a>
                                    </td>
                                </tr>
                            @endforeach
                        @endif
...
<div id="modalEliminar" class="modal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form id="formEliminar" data-url="{{ route('admins.customer.delete') }}">
                {{ csrf_field() }}
                <input type="hidden" name="store_id" id="id_delete">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nameD">¿Está seguro de eliminar este cliente?</label>
