    ...
    <div class="Burger_President_here">
        <div class="single_Burger_President">
            <div class="room_thumb">
                <img src="{{ asset('user/img/burgers/1.png')}}" alt="">
        ...
        <div class="single_Burger_President">
            <div class="room_thumb">
                <img src="{{ asset('user/img/burgers/2.png')}}" alt="">
                <div class="room_heading d-flex justify-content-between align-items-center">
                    <div class="room_heading_inner">
                        <span>$20</span>
                        <h3>The Burger President</h3>
        ...
        <div class="row align-items-center">
            <div class="col-xl-6 col-lg-6 col-md-6">
                <div class="about_thumb2">
                    <div class="img_1">
                        <img src="{{ asset('user/img/about/1.png')}}" alt="">
                    </div>
                    <div class="img_2">
                        <img src="{{ asset('user/img/about/2.png')}}" alt="">
                    </div>
                </div>
            </div>
            <div class="col-xl-5 col-lg-5 offset-lg-1 col-md-6">
                <div class="about_info">
                    ...
                    <div class="img_thumb">
                        <img src="{{ asset('user/img/jessica-signature.png')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="col-lg-8">
                                <div class="single_testmonial text-center">
                                    ...
                                    <div class="testmonial_author">
                                        <div class="thumb">
                                            <img src="{{ asset('user/img/testmonial/1.png')}}" alt="">
                                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="single_testmonial text-center">
                                    ...
                                    <div class="testmonial_author">
                                        <div class="thumb">
                                            <img src="{{ asset('user/img/testmonial/2.png')}}" alt="">
                                        </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                <div class="single_testmonial text-center">
                                    ...
                                    <div class="testmonial_author">
                                        <div class="thumb">
                                            <img src="{{ asset('user/img/testmonial/3.png')}}" alt="">
                                        </div>
                                        <h4>A.H Shemanto</h4>
                                        <div class="stars">
                                            <i class="fa fa-star"></i>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="single_instagram">
                    <img src="{{ asset('user/img/instragram/1.png')}}" alt="">
                    <div class="ovrelay">
                        <a href="#">
                            <i class="fa fa-instagram"></i>
                        </a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single_instagram">
                    <img src="{{ asset('user/img/instragram/2.png')}}" alt="">
                    <div class="ovrelay">
                        <a href="#">
                            <i class="fa fa-instagram"></i>
                        </a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single_instagram">
                    <img src="{{ asset('user/img/instragram/3.png')}}" alt="">
                    <div class="ovrelay">
                        <a href="#">
                            <i class="fa fa-instagram"></i>
                        </a>
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single_instagram">
                    <img src="{{ asset('user/img/instragram/4.png')}}" alt="">
                    <div class="ovrelay">
                        <a href="#">
                            <i class="fa fa-instagram"></i>
                        </a>
